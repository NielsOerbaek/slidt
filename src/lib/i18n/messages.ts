...
export const messages = {
  ...
  'theme_edit.fonts_label': { da: 'SKRIFTTYPER', en: 'FONTS' },
  'theme_edit.header_font_label': { da: 'Overskrift', en: 'Header' },
  'theme_edit.body_font_label': { da: 'Brødtekst', en: 'Body' },
  'theme_edit.font_neureal': { da: 'Neureal (standard)', en: 'Neureal (default)' },
  'theme_edit.font_inter': { da: 'Inter', en: 'Inter' },
  'theme_edit.font_custom': { da: 'Tilpasset Google Font…', en: 'Custom Google Font…' },
  'theme_edit.font_custom_placeholder': { da: 'Playfair Display', en: 'Playfair Display' },
  'theme_edit.tokens_label': { da: 'TOKENS', en: 'TOKENS' },
