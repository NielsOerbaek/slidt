//#region src/lib/i18n/messages.ts
/**
...
var messages = {
	...
	"login.help": {
		da: "— FØRSTE GANG? SPØRG NIELS.",
		en: "— FIRST TIME? ASK NIELS."
	},
	"login.title": {
		da: "Log ind — slidt",
		en: "Sign in — slidt"
	...
	"decks.headline.one": {
		da: "Ét dæk i gang.",
		en: "One deck in motion."
	},
	"decks.headline.many": {
		da: "{word} dæk i gang.",
		en: "{word} decks in motion."
	},
	"empty.tag": {
		da: "TOM · 00 DÆK",
		en: "EMPTY · 00 DECKS"
	...
	"editor.share_dialog_label": {
		da: "DELINGSLINK",
		en: "SHARE LINK"
	},
	"editor.share_dialog_close": {
		da: "LUK",
		en: "CLOSE"
	},
	"editor.share_dialog_copy": {
		da: "KOPIÉR",
		en: "COPY"
	},
	"editor.share_failed": {
		da: "KUNNE IKKE OPRETTE LINK",
		en: "COULD NOT CREATE LINK"
	},
	"editor.agent_on": {
		da: "ON",
		en: "ON"
	...
	"editor.form_empty_no_slides": {
		da: "TILFØJ EN SLIDE FOR AT STARTE.",
		en: "ADD A SLIDE TO START."
	},
	"editor.form_empty_select": {
		da: "VÆLG EN SLIDE FOR AT REDIGERE.",
		en: "SELECT A SLIDE TO EDIT."
	},
	"editor.preview_meta": {
		da: "FORHÅNDSVISNING · 1920×1080",
		en: "PREVIEW · 1920×1080"
	},
	"editor.preview_slide_of": {
		da: "SLIDE {n} / {total}",
		en: "SLIDE {n} / {total}"
	},
	"editor.mob_edit": {
	...
	"agent.hint": {
		da: "SPØRG -_- OM ALT DÆK-AGTIGT…",
		en: "ASK -_- ANYTHING DECK-SHAPED…"
	},
	"agent.expand": {
		da: "▲ FOLD UD  ⌘K",
		en: "▲ EXPAND  ⌘K"
	...
	"agent.compose_placeholder": {
		da: "Spørg -_- om alt dæk-agtigt…",
		en: "Ask -_- for anything deck-shaped…"
	},
	"agent.hello": {
		da: "KLAR. SPØRG OM ALT DÆK-AGTIGT.",
		en: "READY. SAY ANYTHING DECK-SHAPED."
	},
	"agent.tool_pending": {
		da: "…",
		en: "…"
	...
	"editor.picker_head": {
		da: "NY SLIDE · VÆLG TYPE",
		en: "NEW SLIDE · CHOOSE TYPE"
	},
	"editor.picker_close": {
		da: "Luk",
		en: "Close"
	...
	"theme_edit.preview_label": {
		da: "LIVE FORHÅNDSVISNING",
		en: "LIVE PREVIEW"
	},
	"theme_edit.system_prompt_label": {
		da: "AGENT SYSTEMPROMPT",
		en: "AGENT SYSTEM PROMPT"
	},
	...
	"template_edit.fields_label": {
		da: "FELTER (JSON)",
		en: "FIELDS (JSON)"
	},
	"template_edit.template_label": {
		da: "HANDLEBARS-SKABELON",
	...
	"editor.collab_label": {
		da: "SAMARBEJDSPARTNERE",
		en: "COLLABORATORS"
	},
	"editor.collab_role_editor": {
		da: "Redigerer",
		en: "Editor"
	},
	"editor.collab_role_viewer": {
		da: "Læser",
		en: "Viewer"
	},
	"editor.collab_add": {
	...
	"settings.vim_desc": {
		da: "j/k/d/gg/G navigation i dæk-editoren",
		en: "j/k/d/gg/G navigation in the deck editor"
	},
	...
	"settings.language_desc": {
		da: "Brugergrænsefladesprog på tværs af platformen",
		en: "UI language across the platform"
	},
	"settings.save_prefs": {
		da: "Gem præferencer",
		en: "Save preferences"
	...
	"settings.agent_model_desc": {
		da: "LLM til agent-sessioner",
		en: "LLM for agent sessions"
	},
	"settings.agent_model_unavailable": {
		da: "Ollama utilgængeligt",
		en: "Ollama unavailable"
	},
	"settings.api_keys": {
		da: "API-NØGLER",
		en: "API KEYS"
	},
	"settings.key_new_label": {
		da: "NY NØGLE — KOPIÉR NU, DEN VISES IKKE IGEN",
		en: "NEW KEY — COPY NOW, IT WILL NOT BE SHOWN AGAIN"
	},
	"settings.key_dismiss": {
		da: "Afvis",
		en: "Dismiss"
	},
	"settings.key_name_label": {
		da: "NØGLENAVN",
		en: "KEY NAME"
	},
	"settings.key_create": {
	...
	"settings.col_created": {
		da: "Oprettet",
		en: "Created"
	},
	"settings.col_last_used": {
		da: "Sidst brugt",
		en: "Last used"
	},
	"settings.key_revoke": {
	...
	"settings.key_revoke_confirm": {
		da: "Tilbagekald denne nøgle?",
		en: "Revoke this key?"
	},
	"admin.title": {
		da: "Admin — slidt",
	...
	"admin.meta": {
		da: "ADMINPANEL — {n} BRUGERE",
		en: "ADMIN PANEL — {n} USERS"
	},
	"admin.headline": {
		da: "Brugere",
		en: "Users"
	...
	"admin.pw_new_placeholder": {
		da: "Ny adgangskode",
		en: "New password"
	},
	"admin.issue_deck_link": {
		da: "dæk ↗",
		en: "deck ↗"
	},
	"admin.issue_status_open": {
		da: "åben",
		en: "open"
	},
	"admin.issue_status_resolved": {
		da: "løst",
		en: "resolved"
	},
	"admin.issues": {
	...
	"admin.issues_count": {
		da: "{total} total · {open} åbne",
		en: "{total} total · {open} open"
	},
	"admin.issues_empty": {
		da: "Ingen problemer rapporteret endnu.",
	...
	"admin.delete_issue_confirm": {
		da: "Slet dette problem?",
		en: "Delete this issue?"
	},
...
*/
function t(key, params, locale = "da") {
...
function numeralWord(n, locale = "da") {
	return (locale === "en" ? EN_NUMERALS : DA_NUMERALS)[n] ?? String(n);
}
/**
* Headline copy for the decks list, branching on count.
*/
function decksHeadline(count, locale = "da") {
	if (count === 0) return t("decks.headline.zero", void 0, locale);
	if (count === 1) return t("decks.headline.one", void 0, locale);
	return t("decks.headline.many", { word: numeralWord(count, locale) }, locale);
}

export { decksHeadline as d, t };
//# sourceMappingURL=i18n-BH3Uvo8w.js.map
