...
export const osOgData: Theme = {
  name: 'os-og-data-default',
  tokens: {
    // OOD brand palette — used by OOD-specific slide types
    '--ood-white': '#FFFFFF',
    ...
    '--ood-black': '#000000',
    // Semantic tokens — used by general-purpose slide types
    '--sl-bg': '#FFFFFF',
    '--sl-surface': '#EDEDED',
    '--sl-fg': '#363442',
    '--sl-dim': '#807B95',
